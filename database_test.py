...
def test_insert_employee():
    ...
    rows = db.execute(sql, new_first_name = 'Валерий', new_last_name = 'Сорокин', new_middle_name = 'Генадьевич', new_phone = '89217652187', new_email = 'sorok45a@mail.ru', new_birthdate = '1965-07-07', new_avatar_url = 'string', company_id = 3405)
